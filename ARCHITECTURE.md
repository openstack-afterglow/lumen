...
{
  "schema_version": 1,
  "source_sha256": "6dc599df504a45c4f79d667249943baef695869947cfc904e5750b1d4b906751",
  "reviewed_at": "2026-09-24T13:45:05Z",
  "summary": "Staged agent platform change set: plugin API + five default plugin wheels and host/registry/bindings (migration 015), agent infrastructure controller/Nova/Zun-disabled/ingress fence/guest bootstrap and standalone sandbox daemon (016, 018), durable child runs and credit/sandbox budgets with root terminal release (017), long-context cache tier pricing, Kolla/Compose/Docker/CI updates. Structural impact recorded in ARCHITECTURE status rows and docs/agent-platform.md; gates: contract 1283, integration 34, system 9, plugins 88+1 skip, sandbox 21."
}
```
