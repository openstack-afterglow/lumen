...
{
  "schema_version": 1,
  "source_sha256": "e869589de287d96f966ec62da22c0c19b57adaa4b3570d4dc7a8b1582cc90ba3",
  "reviewed_at": "2026-09-26T14:14:17Z",
  "summary": "Reviewed staged tree on origin/dev (title effort fix bbb25d1) plus lumen/services/{capabilities,chat_admission,models_dev,completion_api}.py, lumen/api/conversations.py, lumen.conf.example, tests and docs. Explicit reasoning_effort none returns 422 unless capabilities.reasoning_can_be_disabled; /v1/chat/models exposes reasoning_none_supported; operator chat_reasoning_effort none is omitted for models that cannot (or are not known to) disable reasoning. No new module, storage, migration or route; unit/API-tested only, graph implicit none remains outside admission."
}
```
