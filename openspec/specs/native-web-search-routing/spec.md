# native-web-search-routing Specification

## Purpose
Define executor-bound native Search separately from managed provider search, including exact capability and pricing admission, transport activation, and durable source citations.
